let indentStartTokens,indentEndTokens,indentElseTokens,indentStartOrElseTokens,tokenForIndentStartOrElseTokens,hasStartAndEndToken,phpKeywordStartTokens,phpKeywordEndTokens,util,vsctm;_879‍.x([["default",()=>Formatter]]);_879‍.w("./indent",[["indentStartTokens",["indentStartTokens"],function(v){indentStartTokens=v}],["indentEndTokens",["indentEndTokens"],function(v){indentEndTokens=v}],["indentElseTokens",["indentElseTokens"],function(v){indentElseTokens=v}],["indentStartOrElseTokens",["indentStartOrElseTokens"],function(v){indentStartOrElseTokens=v}],["tokenForIndentStartOrElseTokens",["tokenForIndentStartOrElseTokens"],function(v){tokenForIndentStartOrElseTokens=v}],["hasStartAndEndToken",["hasStartAndEndToken"],function(v){hasStartAndEndToken=v}],["phpKeywordStartTokens",["phpKeywordStartTokens"],function(v){phpKeywordStartTokens=v}],["phpKeywordEndTokens",["phpKeywordEndTokens"],function(v){phpKeywordEndTokens=v}]]);_879‍.w("./util",[["*",null,function(v){util=v}]]);_879‍.w("./vsctm",[["*",null,function(v){vsctm=v}]]);
